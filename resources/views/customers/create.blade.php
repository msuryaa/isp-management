...
<div class="mb-7">
    ...
    <h1 class="font-display text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">Tambah Pelanggan Baru</h1>
    <p class="text-sm text-gray-500 mt-1">Lengkapi data rincian pelanggan baru dengan benar. Seluruh data wajib divalidasi oleh sistem.</p>
</div>
            ...
            <form action="{{ route('customers.store') }}" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" name="internet_package" value="{{ old('internet_package') }}"
                               placeholder="contoh: Home Premium 50M"
